...
online_net = Approximator(args.env_name, exp_name, num_actions, args.optimizer, args.learning_rate, global_step,
                          scope='online', clip_norm=args.clip_norm, create_summary=True)
target_net = Approximator(args.env_name, exp_name, num_actions, args.optimizer, args.learning_rate, global_step,
